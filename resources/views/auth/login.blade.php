    ...
    <section class="flex items-center justify-between space-x-4 rounded-lg bg-white p-4">
        <div class="flex w-1/2 flex-col items-center justify-center space-y-12">
            ...
            <div class="flex w-full flex-col items-center space-y-2">
                ...
                <a href="#" class="text-biru-tertiary flex w-full justify-end font-medium hover:underline">Lupa
                    Password?</a>
            </div>
            <button
                class="bg-biru-tertiary hover:bg-biru-tertiary-hover rounded-xl px-8 py-2 text-lg font-semibold text-white">Log
                In
            </button>
